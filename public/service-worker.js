...
const CACHE_NAME_STATIC = 'lusty-global-static-v4';
const CACHE_NAME_API = 'lusty-global-api-v4';
      ...
      caches.match(request).then((cachedResponse) => {
        ...
        if (cachedResponse) {
          ...
          fetchPromise.catch((err) => {
            console.log('[Service Worker] Silent background refresh failed for:', url.pathname);
          });
          return cachedResponse;
        }
